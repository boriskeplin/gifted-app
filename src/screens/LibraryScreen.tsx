...
// Gift-specific guides — each gift gets its own curated resources
const GIFT_GUIDES: Record<GiftType, Array<{ icon: string; title: string; sub: string }>> = {
  faith: [
    ...
    { icon: '✝', title: 'Promises to Stand On', sub: '40 scriptures for intercessors — when you need them most' },
  ],
  mercy: [
  ...
  prophecy: [
    ...
    { icon: '🔥', title: 'Speaking Truth in Love', sub: 'What your gift is actually called to do — without burning rooms down' },
    { icon: '📖', title: 'Scripture & the Prophetic Gift', sub: 'Every major prophet, what they saw, and what it means for you' },
    { icon: '⚡', title: 'When Nobody Listens', sub: 'The hardest part of the prophetic gift — and what Scripture says about it' },
  ],
  teaching: [
    ...
    { icon: '✝', title: 'Teaching with Authority', sub: 'What Jesus taught about teaching — and what it means for you' },
    { icon: '🏗️', title: 'Building the Church With Your Gift', sub: 'Ephesians 4:11-12 — your assignment in the body' },
    { icon: '📝', title: 'Scripture Memory System', sub: '52 key verses — one per week, gift-specific notes on each' },
  ],
};

// Universal resources (available to all gifts)
...
const VIDEO_COURSES = [
  { id: 'v1', title: 'Walking in Your Gift — Week 1', sub: '4 lessons · 45 min total', free: true },
  { id: 'v2', title: 'Prayer That Moves Heaven', sub: '6 lessons · 1hr 10min', free: false },
  { id: 'v3', title: 'The Prophetic Life', sub: '5 lessons · 55 min total', free: false },
  { id: 'v4', title: 'Mercy, Service & Burnout', sub: '4 lessons · 50 min total', free: false },
  { id: 'v5', title: 'Teaching Scripture That Changes Lives', sub: '6 lessons · 1hr 20min', free: false },
];
...
export default function LibraryScreen({ user }: Props) {
  ...
  const handleLocked = () => setShowPaywall(true);
        ...
        <View style={styles.page}>
          ...
          {guides.map((item, i) => (
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              onPress={() => !user.subscribed ? handleLocked() : null}
            >
          ...
          {VIDEO_COURSES.map(item => (
            <TouchableOpacity
              ...
              style={styles.libItem}
              activeOpacity={0.7}
              onPress={() => !item.free && !user.subscribed ? handleLocked() : null}
            >
          ...
          <View style={styles.aiCard}>
            ...
            <Text style={styles.aiSub}>
              Ask anything about your spiritual gift, Scripture, prayer, or calling.
              Trained on all 8 guides and thousands of biblical references.
              Knows your gift. Speaks to your specific calling.
            </Text>
            {user.subscribed ? (
              ...
              <TouchableOpacity
                ...
                onPress={() => Linking.openURL('https://gifted.church/upgrade')}
              >
          ...
          {!user.subscribed && (
            <View style={styles.convictionClose}>
              ...
              <Text style={styles.convictionSub}>
                The guides in this library exist to help you do exactly that.
              </Text>
            </View>
          )}
